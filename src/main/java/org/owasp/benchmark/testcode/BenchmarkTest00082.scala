...
class BenchmarkTest00082 extends HttpServlet {
    ...
    def doPost(request: HttpServletRequest, response: HttpServletResponse): Unit = {
        ...
        var sbxyz58640: StringBuilder = new StringBuilder(param)
        var bar: String = sbxyz58640.append("_SafeStuff").toString()

        var randNumber: Int = new java.util.Random().nextInt(99)
        var rememberMeKey: String = Integer.toString(randNumber)

        var user: String = "Inga"
