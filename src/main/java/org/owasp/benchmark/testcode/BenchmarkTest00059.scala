...
class BenchmarkTest00059 extends HttpServlet {
    ...
    def doPost(request: HttpServletRequest, response: HttpServletResponse): Unit = {
        ...
        var sbxyz22532: StringBuilder = new StringBuilder(param)
        var bar: String = sbxyz22532.append("_SafeStuff").toString()
        ...
        try {
            ...
            var algorithm: String = benchmarkprops.getProperty("cryptoAlg2", "AES/ECB/PKCS5Padding")
